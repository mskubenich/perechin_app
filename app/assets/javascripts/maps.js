...
j(document).ready(function(){
    ...
    j('#showplace_description').elrte(opts);
    j('#poi_form').submit(function(){
        var form = j(this);
        ...
        form.find('#showplace_description').val(form.find('iframe').get(0).contentWindow.document.body.innerHTML);
        //return false;
    });
});