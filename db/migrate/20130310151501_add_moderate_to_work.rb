class AddModerateToWork < ActiveRecord::Migration
  def change
    add_column :works, :moderate, :boolean
    ...
    actions = [Action.create(:controller => "arts", :action => :subcategories_for_category, :method => :post)]
