class AddAnecdoteActions < ActiveRecord::Migration
  def change
    ...
    actions = []
    actions << Action.create(:controller => "anecdotes", :action => "index" , :method => :get)
    ...
    actions = []
    actions << Action.create(:controller => "anecdotes", :action => "new" , :method => :get)
    actions << Action.create(:controller => "anecdotes", :action => "create" , :method => :post)
    actions << Action.create(:controller => "anecdotes", :action => "edit" , :method => :get)
    actions << Action.create(:controller => "anecdotes", :action => "update" , :method => :post)
    actions << Action.create(:controller => "anecdotes", :action => "destroy" , :method => :post)
    actions.each do |action|
      ControllerRolePermission.create :role_id => admin.id, :action_id => action.id, :has_access => true
